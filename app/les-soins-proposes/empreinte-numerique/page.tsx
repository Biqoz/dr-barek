...
export default function Home() {
  const videoUrl = "/videos/EmpreinteNumerique.mp4";
        ...
        A8
          ...
          <div className="space-y-4">
            <div className="rounded-lg border-2 border-dashed border-black p-4">
              <h3 className="mb-2 text-xl font-semibold">B8</h3>
              <p className="mb-4  text-8xl  ">
        C8
          </p>
            </div>
            ...
            <div className="rounded-lg border-2 border-dashed border-black p-4">
              <h3 className="mb-2 text-xl font-semibold">D8</h3>
